export const EXPERIENCE = [
  {
    ...
    summary: '3 Roles · 8 Years',
    roles: [
      {
        title: 'Senior Manager, Service',
      ...
      {
        title: 'Manager, Client Solutions — Team Lead',
        period: 'Mar 2022 – Oct 2023',
        bullets: [
          'Managed a team of client solutions specialists while carrying a personal enterprise book — bridging IC delivery and people management during a high-growth phase.',
          'Founded and scaled an internal Center of Excellence (CoE): built playbooks, onboarding templates, and Agile-driven performance cadences adopted team-wide.',
          'Led cross-functional coordination with product, legal, and operations to resolve complex client escalations and protect retention in a high-touch model.',
          'Developed renewal forecasting models and pipeline tracking in Salesforce that improved quarterly accuracy and provided cleaner visibility into at-risk accounts.',
        ],
        tags: ['CoE Design', 'Playbook Development', 'Renewal Forecasting', 'Cross-functional Alignment'],
      },
      {
        title: 'Associate → Senior Client Solutions Manager',
